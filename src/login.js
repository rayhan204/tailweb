...
import Bgburger from "../src/assets/aboutBG.jpg";
    ...
    >
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden  ">
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div class="w-full bg-opacity-5 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:bg-opacity-90 dark:border-gray-700">
            <div class="p-6 mx-6 space-y-4 md:space-y-6 sm:p-8 lg:p-16">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <a href="/" class="text-sm font-medium text-slate-300 hover:underline dark:text-primary-500">
                    Forgot password?
                  </a>
                </div>
                <button
